...
import MenuPage from "../menu/[id]/page";
...
const RestaurantDetailsPage = async ({ params: { id } }: Props) => {
    ...
    <div className="w-full min-h-screen flex flex-col">
      ...
      <div className="relative w-full h-[400px]">
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <h1 className="text-white text-4xl md:text-6xl font-bold drop-shadow-lg">{restaurant.name}</h1>
        </div>
      </div>
      ...
      <div className="flex-1 p-6 md:p-10">
        <Tabs defaultValue="About" className="w-full">
          <TabsList className="flex justify-center mb-6">
            ...
            <TabsTrigger value="Menu" className="text-lg">Menu</TabsTrigger>
          </TabsList>

          {/* About Tab */}
          <TabsContent value="About">
            <div className="space-y-6">
              <h2 className="text-3xl italic font-semibold underline">About {restaurant.name}</h2>
